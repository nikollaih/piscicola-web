                                ...
                                <table id="table-expenses" className="w-full table table-auto">
                                    ...
                                    <tbody>
                                        {expenses.data.map((expense) => (
                                            <tr key={expense.id} id={expense.id} className="hover:bg-gray-100 hover:cursor-pointer rounded-2xl overflow-hidden w-full">
                                                ...
                                                <td className="flex gap-2 py-4">
                                                    <div className="flex gap-2 pr-4">
                                                        ...
                                                        <svg onClick={() => confirmDeleteExpense(expense.id)} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1" stroke="currentColor" className="w-5 h-5 text-red-600">
                                                            <path strokeLinecap="round" strokeLinejoin="round"
