...
export default function SowingInformation ({sowing}) {
    const [showSowing, setShowSowing] = useState(false);
    ...
    return <div >
        ...
        <Link href={route('sowing.view', {sowingId: sowing.id})} className={(showSowing ? "block" : "hidden") + " p-3 hover:bg-gray-100 rounded-md transition duration-2000 ease-in-out"}>
            <div className="mb-3">
