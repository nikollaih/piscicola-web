    ...
    const deleteParty = async (partyId) => {
        try {
            ...
            if (response.ok) {
                ...
                throw new Error(jsonResponse.msg || 'No se pudo eliminar.');
            }
        } catch (error) {
            Swal.fire({
                title: "Error",
                        ...
                        <table id="table-parties" className="w-full table table-auto">
                            ...
                            <tbody>
                                {partiesList.map((party) => (
                                    <tr key={party.id} className="hover:bg-gray-100 hover:cursor-pointer rounded-2xl overflow-hidden">
                                        ...
                                        <td className="flex gap-2 py-4 pr-4">
                                            ...
                                            <svg onClick={() => confirmDeleteParty(party)} xmlns="http://www.w3.org/2000/svg" fill="none"
